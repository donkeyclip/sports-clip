...
clip.addIncident(
  moveBottom("100%", ".rectangle.top", 200, 0, { bottom: "50%" }),
  400
);
clip.addIncident(
  moveTop("100%", ".rectangle.bottom", 200, 0, { top: "50%" }),
  400
);
clip.addIncident(
  moveLeft("100%", ".rectangle.right", 200, 0, { left: "50%" }),
  400
);
clip.addIncident(
  moveRight("100%", ".rectangle.left", 200, 0, { right: "50%" }),
  400
);
...
clip.addIncident(
  opacity(0.5, ".intro .name-back .letter", 200, "@stagger(0,300)"),
  500
);
clip.addIncident(letterSpacing("2px", ".name-back", 400), 600);

clip.addIncident(
  opacity(1, ".intro .name .letter", 700, "@expression(random(500))"),
  700
);
clip.addIncident(letterSpacing("0px", ".intro .name", 400), 700);

clip.addIncident(
  opacity(1, ".intro .subtitle .letter", 700, "@expression(random(200))"),
  900
);
clip.addIncident(letterSpacing("5px", ".intro .subtitle", 400), 900);

clip.addIncident(
  changeColor("@initParams.accentColor", ".intro .name", 1),
  1000
);
clip.addIncident(
  changeColor("@initParams.secondaryColor", ".intro .name", 1),
  1100
);

clip.addIncident(opacity(1, ".intro .block", 1), 1300);
clip.addIncident(
  changeBackgroundColor("@initParams.baseColor", ".intro .block", 1),
  1325
);
clip.addIncident(
  changeBackgroundColor("@initParams.accentColor", ".intro .block", 1),
  1350
);
clip.addIncident(
  changeBackgroundColor("@initParams.baseColor", ".intro .block", 1),
...
clip.addIncident(
  heightMove("0%", ".intro .block", 100, { height: "40%" }),
  1400
);

clip.addIncident(
  widthMove("23%", ".intro .wide-line", 800, "@stagger(0,300)"),
  700
);
clip.addIncident(
  widthMove("10%", ".intro .slim-line", 600, "@stagger(0,300)"),
  900
);
